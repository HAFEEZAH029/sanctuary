    ...
    <div className="w-64 bg-gray-50 flex flex-col justify-between p-4 border-r border-gray-200">
      <div>
        ...
        <nav className="space-y-1">
          <div className="flex items-center gap-3 bg-blue-50 text-blue-600 p-3 rounded-lg cursor-pointer">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
            </svg>
            <button onClick={onViewChat} className="font-medium outline-none border-none cursor-pointer">Chats</button>
          </div>
      ...
      {/* Bottom */}
      <div>
        <button onClick={onNewChat} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2.5 rounded-lg mb-4 font-medium transition flex items-center justify-center gap-2 cursor-pointer">
